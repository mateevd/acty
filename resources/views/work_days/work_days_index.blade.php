...
{{--HISTORIQUE UTILISATEUR--}}
		<div class="flex-row flex-wrap-no justify-between items-center default-entity-title"
			...
			<div class="flex-row flex-wrap-yes justify-flex-end pad-h-small pad-v-top-medium pad-v-bottom-small">
				...
				<div class="flex-row flex-wrap-no justify-flex-end pad-h-small width-rem-15">
					<span class="default-entity-title-label">Réalisé <span class="exp-annee">({{substr(\Carbon\Carbon::parse($current_date)->format('m/Y'), 0, 2).'/'.substr(\Carbon\Carbon::parse($current_date)->format('m/Y'), 5, 2)}})</span> : </span>
					<span class="default-entity-title-data style-realise">{{number_format($user_total_realise_month, '3', ',', ' ')}}</span>
				</div>
				<div class="flex-row flex-wrap-no justify-flex-end pad-h-small width-rem-15">
					<span class="default-entity-title-label">Restant <span class="exp-annee">({{substr(\Carbon\Carbon::parse($current_date)->format('m/Y'), 0, 2).'/'.substr(\Carbon\Carbon::parse($current_date)->format('m/Y'), 5, 2)}})</span> : </span>
	...
	<div class="tab-pane" role="tabpanel" id="cra">
		<div class="flex-row flex-wrap-no justify-between items-center default-entity-title"
			...
			<div class="flex-row flex-wrap-yes justify-flex-end pad-h-small pad-v-top-medium pad-v-bottom-small">
				<div class="flex-row flex-wrap-no justify-flex-end pad-h-small width-rem-20">
					<span class="default-entity-title-label">{{ucfirst(trans('app.running'))}} <span class="exp-annee">({{substr(\Carbon\Carbon::parse($current_date)->format('m/Y'), 0, 2).'/'.substr(\Carbon\Carbon::parse($current_date)->format('m/Y'), 5, 2)}})</span> : </span>
					<span class="default-entity-title-data">{{number_format($cra_entity->realise_active, '3', ',', ' ')}}</span>
				</div>
				<div class="flex-row flex-wrap-no justify-flex-end pad-h-small width-rem-20">
					<span class="default-entity-title-label">{{ucfirst(trans('app.terminated_man'))}} <span class="exp-annee">({{substr(\Carbon\Carbon::parse($current_date)->format('m/Y'), 0, 2).'/'.substr(\Carbon\Carbon::parse($current_date)->format('m/Y'), 5, 2)}})</span> : </span>
					<span class="default-entity-title-data tr-task-terminated">{{number_format($cra_entity->realise_terminated, '3', ',', ' ')}}</span>
				</div>
				<div class="flex-row flex-wrap-no justify-flex-end pad-h-small width-rem-20">
					<span class="default-entity-title-label">{{ucfirst(trans('app.denied_man'))}} <span class="exp-annee">({{substr(\Carbon\Carbon::parse($current_date)->format('m/Y'), 0, 2).'/'.substr(\Carbon\Carbon::parse($current_date)->format('m/Y'), 5, 2)}})</span> : </span>
					<span class="default-entity-title-data tr-task-not-validated">{{number_format($cra_entity->realise_not_validated, '3', ',', ' ')}}</span>
				</div>
				<div class="flex-row flex-wrap-no justify-flex-end pad-h-small width-rem-20">
					<span class="default-entity-title-label">{{ucfirst(trans('app.validated_man'))}} <span class="exp-annee">({{substr(\Carbon\Carbon::parse($current_date)->format('m/Y'), 0, 2).'/'.substr(\Carbon\Carbon::parse($current_date)->format('m/Y'), 5, 2)}})</span> : </span>
		...
		@if(isset($cra_users))
		<div id="user_card" class="flex-row flex-wrap-yes justify-flex-start items-center user-card-outer-separator">
			@foreach($cra_users as $cra_user)
				...
				<div class="flex-col flex-wrap-no justify-flex-start items-center width-rem-25 height-rem-15 marg-small user-card">
					...
					<div class="flex-row flex-wrap-yes justify-flex-start items-center user-card-title user-card-inner-separator width-100">
					...
					<div class="flex-row flex-wrap-yes justify-between user-card-days bg-important-back width-100">
							<div class="flex-row flex-wrap-no justify-flex-start pad-h-small width-rem-12">
								<span class="user-card-days-label">{{ucfirst(trans('app.running'))}} : </span>	
							...
							<div class="flex-row flex-wrap-no justify-flex-end pad-h-small width-rem-12">
								<span class="user-card-days-label">{{ucfirst(trans('app.denied_man'))}} : </span>
								<span class="user-card-days-data tr-task-not-validated">{{number_format($cra_user->realise_not_validated, '3', ',', ' ')}}</span>
							</div>
							<div class="flex-row flex-wrap-no justify-flex-start pad-h-small width-rem-12">
								<span class="user-card-days-label">{{ucfirst(trans('app.terminated_man'))}} : </span>
								<span class="user-card-days-data tr-task-terminated">{{number_format($cra_user->realise_terminated, '3', ',', ' ')}}</span>
							</div>
							<div class="flex-row flex-wrap-no justify-flex-end pad-h-small width-rem-12">
								<span class="user-card-days-label">{{ucfirst(trans('app.validated_man'))}} : </span>
