<div class="flex-row flex-wrap-yes justify-evenly items-flex-start pad-h-medium pad-v-top-small pad-v-bottom-medium width-100">
	...
	<div class="flex-col flex-wrap-no justify-center align-stretch pad-h-only-small">
		<div class="flex-col flex-wrap-no justify-center pad-v-small align-stretch width-100">
			...
			{{ Form::text("user_first_name", null,["class"=>"form-control m-field-input", 'placeholder'=>null, 'required', 'tabindex'=>'1']) }}
		...
		<div class="flex-col flex-wrap-no justify-center pad-v-small align-stretch width-100">
			<div class="flex-row flex-wrap-no justify-center">
				<div class="show-warning-small pad-h-right-mini">*</div>
				{!! Form::label("user_department_id", trans('users.Department'),["class"=>"flex-row flex-wrap-yes justify-evenly form-label control-label"]) !!}
			</div>
			@if(auth()->user()->role_id == config('constants.role_admin_id'))
				{!! Form::select("user_department_id", $departments, auth()->user()->department_id,["class"=>"form-control m-field-input", 'required', 'tabindex'=>'5']) !!}
			@else
				{!! Form::select("user_department_id", $departments, auth()->user()->department_id,["class"=>"form-control m-field-input", 'required', 'tabindex'=>'5', 'disabled']) !!}
			@endif
			<div class="invalid-feedback show-warning-small">{{ucfirst(trans('app.mandatory'))}}</div>
		</div>
		<div class="flex-col flex-wrap-no justify-center pad-v-small align-stretch width-100">
	...
	<div class="flex-col flex-wrap-no justify-center align-stretch pad-h-only-small justify-between">
		<div class="flex-col flex-wrap-no justify-center pad-v-small align-stretch width-100">
			...
			{{ Form::text("user_last_name", null,["class"=>"form-control m-field-input", 'placeholder'=>null, 'required', 'tabindex'=>'2']) }}
			<div class="invalid-feedback show-warning-small">{{ucfirst(trans('app.mandatory'))}}</div>
		</div>
		<div class="flex-col flex-wrap-no justify-center pad-v-small align-stretch width-100">
			<div class="flex-row flex-wrap-no justify-center">
		...
		<div class="flex-col flex-wrap-no justify-center pad-v-small align-stretch width-100">
			<div class="flex-row flex-wrap-no justify-center">
				<div class="show-warning-small pad-h-right-mini">*</div>
				{!! Form::label("user_service_id", trans('users.Service'),["class"=>"flex-row flex-wrap-yes justify-evenly form-label control-label"]) !!}
			</div>
